...
export const en = {
  ...
  buffBadge: {
    faster_growth:      (pct: number) => `-${pct}% Growth time`,
  ...
  shopSectionFreeCollections: 'Personal Collections',
  shopFreeHerbariumTitle: 'Buy Herbarium',
  shopFreeHerbariumDesc: (count: number, max: number) => `${count} of ${max}. Fill it freely with any blooms from your garden.`,
  shopFreeBkTitle: 'Buy Planter Box',
  shopFreeBkDesc: (count: number, max: number) => `${count} of ${max}. Fill it freely with any blooms from your garden.`,
  shopFreeCollMax: 'Maximum reached',
  collFreeSize: 'Size',
  ...
  seedLupeBtn: 'Loupe',
  seedLupeHint: 'Hover over a seed to preview its bloom',
...
// ─── Collections ──────────────────────────────────────────────────────────────
  ...
  collInProgressTitle:     'In Progress',
  collDoneTitle:           'Completed',
  collAddFavorite:         'Add to favorites',
  collRemoveFavorite:      'Remove from favorites',
  collFavoritesFull:       'Max. 4 favorites',
  ...
  collectionDefs: {
    ...
    pastell_kasten:            { title: 'Pastel Box',               desc: 'Six colour buckets in soft L90 — gentle and dreamlike.' },
    mondlichtnacht:            { title: 'Moonlit Night',            desc: 'Six dark or grey blooms — like a garden in moonlight.' },
    blaue_stunde:              { title: 'Blue Hour',                desc: 'Blue and violet in deep tones — like a garden at dusk.' },
    winterfenster:             { title: 'Winter Window',            desc: 'White, grey and cool blue — a window box for the cold season.' },
    sommerwiese:               { title: 'Summer Meadow',            desc: 'Five warm blooms in yellow, orange-red and red — like a summer meadow.' },
    herbstkiste:               { title: 'Autumn Box',               desc: 'Rust, mustard and carmine — warm dark tones like an autumn garden.' },
    feuer_und_glut:            { title: 'Fire & Embers',            desc: 'Intense dark red, rust and pink — a glowing window box.' },
    farbenrausch:              { title: 'Color Frenzy',             desc: 'Seven blooms in all seven colors — a box bursting with life.' },
    helligkeitsstufen:         { title: 'Brightness Levels',        desc: 'Three blooms in the three lightness levels — light, medium and dark.' },
    gemeine_formen:            { title: 'The Common Shapes',        desc: 'The three most common petal shapes: Round, Lance and Teardrop.' },
    die_fuenf_formen:          { title: 'The Five Shapes',          desc: 'One bloom of each petal shape — from common to legendarily rare.' },
    runde_bluetenfuelle:       { title: 'Round Abundance',          desc: 'Round blooms with three, five and eight petals — from sparse to full.' },
    lanzett_bluetenfuelle:     { title: 'Lance Abundance',          desc: 'Lance blooms with three, five and eight petals.' },
    tropfen_bluetenfuelle:     { title: 'Teardrop Abundance',       desc: 'Teardrop blooms with three, five and eight petals.' },
    wavy_bluetenfuelle:        { title: 'Wavy Abundance',           desc: 'Wavy blooms with three, five and eight petals.' },
    zickzack_bluetenfuelle:    { title: 'Zigzag Abundance',         desc: 'Zigzag blooms with three, five and eight petals.' },
    die_drei_mitten:           { title: 'The Three Centers',        desc: 'One bloom each with dot, disc and stamen centers.' },
    farbeffekte:               { title: 'Petal Effects',            desc: 'All four petal effects in one collection: Bicolor, Gradient, Shimmer and Iridescent.' },
    regenbogen:                { title: 'Rainbow',                  desc: 'Five blooms in five different colors — a spectrum in a frame.' },
    rote_reihe:                { title: 'Red Series',               desc: 'Carmine, rust and ruby — three red tones at medium lightness.' },
    gruengelbe_reihe:          { title: 'Yellow-Green Series',      desc: 'Yellow and emerald — the two groups of the yellow-green spectrum.' },
    rosa_reihe:                { title: 'Pink Series',              desc: 'Magenta, fuchsia and burgundy — three pink tones at medium lightness.' },
    blaue_reihe:               { title: 'Blue Series',              desc: 'Turquoise, azure and navy — three blue tones at medium lightness.' },
    violette_reihe:            { title: 'Violet Series',            desc: 'Grey-violet and amethyst — the two groups of the violet spectrum.' },
    achromatisches_herbarium:  { title: 'Achromatic Herbarium',     desc: 'White and grey in all three levels — blooms without colour saturation.' },
    katalog_der_kostbarkeiten: { title: 'Catalog of Rarities',      desc: 'Three blooms of increasing rarity — from rare to legendary.' },
    free_herbarium_0: { title: 'Free Herbarium 1', desc: '' },
    free_herbarium_1: { title: 'Free Herbarium 2', desc: '' },
    free_herbarium_2: { title: 'Free Herbarium 3', desc: '' },
    free_herbarium_3: { title: 'Free Herbarium 4', desc: '' },
    free_herbarium_4: { title: 'Free Herbarium 5', desc: '' },
    free_blumenkasten_0: { title: 'Free Planter Box 1', desc: '' },
    free_blumenkasten_1: { title: 'Free Planter Box 2', desc: '' },
    free_blumenkasten_2: { title: 'Free Planter Box 3', desc: '' },
    free_blumenkasten_3: { title: 'Free Planter Box 4', desc: '' },
    free_blumenkasten_4: { title: 'Free Planter Box 5', desc: '' },
