...
export const de = {
  ...
  shopSectionFreeCollections: 'Eigene Sammlungen',
  shopFreeHerbariumTitle: 'Herbarium kaufen',
  shopFreeHerbariumDesc: (count: number, max: number) => `${count} von ${max}. Befülle es frei mit beliebigen Blüten aus deinem Garten.`,
  shopFreeBkTitle: 'Blumenkasten kaufen',
  shopFreeBkDesc: (count: number, max: number) => `${count} von ${max}. Befülle ihn frei mit beliebigen Blüten aus deinem Garten.`,
  shopFreeCollMax: 'Maximum erreicht',
  collFreeSize: 'Größe',
...
// ─── Collections ──────────────────────────────────────────────────────────────
  ...
  collInProgressTitle:     'In Arbeit',
  collDoneTitle:           'Abgeschlossen',
  collAddFavorite:         'Favorisieren',
  collRemoveFavorite:      'Aus Favoriten entfernen',
  collFavoritesFull:       'Maximal 4 Favoriten',
  ...
  collectionDefs: {
    ...
    pastell_kasten:            { title: 'Pastellkasten',            desc: 'Sechs Farbbuckets in sanftem L90 — weich und traumhaft.' },
    mondlichtnacht:            { title: 'Mondlichtnacht',           desc: 'Sechs dunkle oder graue Blüten — wie ein Garten im Mondschein.' },
    blaue_stunde:              { title: 'Blaue Stunde',             desc: 'Blau und Violett in tiefen Tönen — wie ein Garten in der Abenddämmerung.' },
    winterfenster:             { title: 'Winterfenster',            desc: 'Weiß, Grau und kühles Blau — ein Blumenkasten für die kalte Jahreszeit.' },
    sommerwiese:               { title: 'Sommerwiese',              desc: 'Fünf warme Blüten in Gelb, Orangerot und Rot — wie eine Sommerwiese.' },
    herbstkiste:               { title: 'Herbstkiste',              desc: 'Rost, Senf und Karmin — warme dunkle Töne wie ein Herbstgarten.' },
    feuer_und_glut:            { title: 'Feuer & Glut',             desc: 'Intensives Dunkelrot, Rost und Rosa — ein glühender Blumenkasten.' },
    farbenrausch:              { title: 'Farbenrausch',             desc: 'Sieben Blüten in allen sieben Farben — ein wilder Kasten voller Leben.' },
    helligkeitsstufen:         { title: 'Helligkeitsstufen',        desc: 'Drei Blüten in den drei Helligkeitsstufen — hell, mittel und dunkel.' },
    gemeine_formen:            { title: 'Die gemeinen Formen',      desc: 'Die drei häufigsten Blütenformen: Rund, Lanzett und Tropfen.' },
    die_fuenf_formen:          { title: 'Die fünf Formen',          desc: 'Je eine Blüte jeder Blütenform — von gewöhnlich bis legendär selten.' },
    runde_bluetenfuelle:       { title: 'Runde Blütenfülle',        desc: 'Runde Blüten mit drei, fünf und acht Blütenblättern — von karg bis voll.' },
    lanzett_bluetenfuelle:     { title: 'Lanzett-Blütenfülle',      desc: 'Lanzettblüten mit drei, fünf und acht Blütenblättern.' },
    tropfen_bluetenfuelle:     { title: 'Tropfen-Blütenfülle',      desc: 'Tropfenblüten mit drei, fünf und acht Blütenblättern.' },
    wavy_bluetenfuelle:        { title: 'Gewellte Blütenfülle',     desc: 'Gewellte Blüten mit drei, fünf und acht Blütenblättern.' },
    zickzack_bluetenfuelle:    { title: 'Zickzack-Blütenfülle',     desc: 'Zickzackblüten mit drei, fünf und acht Blütenblättern.' },
    die_drei_mitten:           { title: 'Die drei Mitten',          desc: 'Je eine Blüte mit Punkt-, Scheiben- und Staubblattzentrum.' },
    farbeffekte:               { title: 'Farbeffekte',              desc: 'Alle vier Farbeffekte in einer Sammlung: Zweifarbig, Verlauf, Schimmer und Schillernd.' },
    regenbogen:                { title: 'Regenbogen',               desc: 'Fünf Blüten in fünf verschiedenen Farben — ein Spektrum im Rahmen.' },
    rote_reihe:                { title: 'Rote Reihe',               desc: 'Karmin, Rost und Rubin — drei Rottöne in mittlerer Helligkeit.' },
    gruengelbe_reihe:          { title: 'Grüngelbe Reihe',          desc: 'Gelb und Smaragd — die zwei Gruppen des Grüngelb-Spektrums.' },
    rosa_reihe:                { title: 'Rosa Reihe',               desc: 'Magenta, Fuchsia und Burgund — drei Rosatöne in mittlerer Helligkeit.' },
    blaue_reihe:               { title: 'Blaue Reihe',              desc: 'Türkis, Azur und Marine — drei Blautöne in mittlerer Helligkeit.' },
    violette_reihe:            { title: 'Violette Reihe',           desc: 'Grauviolett und Amethyst — die zwei Gruppen des Violett-Spektrums.' },
    achromatisches_herbarium:  { title: 'Achromatisches Herbarium', desc: 'Weiß und Grau in allen drei Stufen — Blüten ohne Farbsättigung.' },
    katalog_der_kostbarkeiten: { title: 'Katalog der Kostbarkeiten', desc: 'Drei Blüten von wachsender Seltenheit — von selten bis legendär.' },
    free_herbarium_0: { title: 'Freies Herbarium 1', desc: '' },
    free_herbarium_1: { title: 'Freies Herbarium 2', desc: '' },
    free_herbarium_2: { title: 'Freies Herbarium 3', desc: '' },
    free_herbarium_3: { title: 'Freies Herbarium 4', desc: '' },
    free_herbarium_4: { title: 'Freies Herbarium 5', desc: '' },
    free_blumenkasten_0: { title: 'Freier Blumenkasten 1', desc: '' },
    free_blumenkasten_1: { title: 'Freier Blumenkasten 2', desc: '' },
    free_blumenkasten_2: { title: 'Freier Blumenkasten 3', desc: '' },
    free_blumenkasten_3: { title: 'Freier Blumenkasten 4', desc: '' },
    free_blumenkasten_4: { title: 'Freier Blumenkasten 5', desc: '' },
