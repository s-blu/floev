...
export const de = {
  ...
  buffLevelLabel:      (current: number, max: number) => `Stufe ${current} / ${max}`,
  buffNotYetLabel:     'Noch nicht freigeschaltet',
  buffMaxed:           'Maximal',
  ...
  buffReqColorBucket:  (b: string) => b,
  buffReqColorOr:      (buckets: string[]) => buckets.join('/'),
